...
contract BeefyOpAuraEthTripletsLpIntegrationTest is BaseIntegration {
    uint256 fork;
    uint256 forkBlock = 128223898;
    uint256 forkBlockTimestamp = 1732046573;

    address internal _beefyWrapper = address(0x182be93E1C0C4d305fe43bD093292F21fd679797);

    address internal _asset = address(0x5F8893506Ddc4C271837187d14A9C87964a074Dc);
    address internal _assetWhale = address(0xBA12222222228d8Ba445958a75a0704d566BF2C8);
    address internal _yieldVault;
    address internal _mooVault = address(0x9236cd1Cb2df141E842F825B95f51742CC930814);
    address internal _mooYieldSource = address(0x3a3F74439B6B44D7d591535Ca01D158Fe1E4d535);

    /* ============ setup ============ */

    function setUpUnderlyingAsset() public virtual override returns (IERC20 asset, uint8 decimals, uint256 approxAssetUsdExchangeRate) {
        return (IERC20(_asset), 18, 3205e18);
    }
