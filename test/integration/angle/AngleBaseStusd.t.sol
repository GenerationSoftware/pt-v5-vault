...
contract AngleBaseStusdIntegrationTest is BaseIntegration {
    uint256 fork;
    uint256 forkBlock = 14352958;
    uint256 forkBlockTimestamp = 1715495263;

    address internal _asset = address(0x0000206329b97DB379d5E1Bf586BbDB969C63274);
    address internal _assetWhale = address(0x79eF3eCDa775860a2351ae2A7B80C4d80ba47F72);
